...
template<> STREAMLINEBLUEPRINT_API UScriptStruct* StaticStruct<FStreamlineFeatureRequirements>()
{
	...
	struct Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_3869166627(TEXT("/Script/StreamlineBlueprint"),
		Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Proj_Dirk_Plugins_nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibrary_h_Statics::EnumInfo));
